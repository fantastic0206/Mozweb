...
?>
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P8973JS" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
            ...
            <div class="col-md-6 col-sm-5 col-xs-12">
                <div class="header-top-right">
                    <ul>
                        ...
                        <li><a href="https://cliente.mozweb.co.mz/clientarea.php?<?php echo $lang['whmcs_lang_parameter']; ?>"><span class="fal fa-user"></span><?php echo $lang['header_login_button']; ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
