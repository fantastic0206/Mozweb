        ...
        <div class="container">
            <div class="row form_row">
                ...
                <div class="col-sm-5 detail_address">
                    ...
                    <br><br>
                    <h4><?php echo $lang['contacto_content_15']; ?></h4>
                    <center><iframe src="https://www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2Fmozweb.co.mz&amp;width=380&amp;height=220&amp;colorscheme=dark&amp;show_faces=true&amp;header=false&amp;stream=false&amp;show_border=true" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:380px; height:220px;" allowTransparency="true"></iframe></center>
                </div>
            </div>
            <div class="row we_support">
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-4 we_support-3">
                            <div class="media">
