...
<title><?php echo $lang['ferramenta_ping_title'];?></title>
<meta name="description" content="<?php echo $lang['ferramenta_ping_description'];?>">
<meta name="keywords" content="<?php echo $lang['ferramenta_ping_keywords'];?>">
<link rel="canonical" href="<?php echo $lang['ferramenta_ping_canonical_url'];?>">
<meta property="og:title" content="<?php echo $lang['ferramenta_ping_title'];?>">
<meta property="og:description" content="<?php echo $lang['ferramenta_ping_description'];?>">
<meta property="og:type" content="website">
<meta property="og:url" content="<?php echo $lang['ferramenta_ping_canonical_url'];?>">
<meta property="og:image" content="<?php echo $lang['ferramenta_ping_meta_img'];?>">
<meta property="og:site_name" content="MOZWEB">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="660">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@mozwebmz">
<meta name="twitter:title" content="<?php echo $lang['ferramenta_ping_title'];?>">
<meta name="twitter:description" content="<?php echo $lang['ferramenta_ping_description'];?>">
<meta name="twitter:image" content="<?php echo $lang['ferramenta_ping_meta_img'];?>">
...
<form action="ping" id="testresult">
...
if (isset($_GET['host'])) {
    ...
    echo "<p><strong>Starting Ping...</strong></p><br>";
    for($x=0; $x < count($return['status']); $x++)
    {
        echo $return['status'][$x];
        echo "<br>";
    }
    echo "<br><br><p><strong>Ping Completed</strong><p>";
	echo '</pre>';
    // ---------------------------
}
/*
