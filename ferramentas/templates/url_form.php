...
<div id="top_form">
    ...
    <div style="width:800px; margin:0 auto;">
        ...
        <form method="post" action="https://www.mozweb.co.mz/ferramentas/testador-de-site" target="_top" style="margin:0; padding:0;">
            <input type="button" value="Home" onclick=" window.location.href='https://www.mozweb.co.mz/ferramentas/testador-de-site'">
