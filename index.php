                ...
                <div class="slide_caption row m0">
                    <div class="container">
                        <div>
                            ...
                            <a href="<?php echo $lang['header_menu_link_3']; ?>" class="pkg_price">
                ...
                <div class="slide_caption row m0">
                    <div class="container">
                        <div>
                            ...
                            <a href="<?php echo $lang['header_menu_link_2']; ?>" class="pkg_price">
                                <script src="https://cliente.mozweb.co.mz/feeds/productsinfo-sec.php?pid=40&get=price&billingcycle=monthly<?php echo $lang['website_currency']; ?>"></script>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="slide_caption row m0">
                    <div class="container">
                        <div>
                            ...
                            <a href="<?php echo $lang['header_menu_link_12']; ?>" class="pkg_price">
                                <script language="javascript" src="https://cliente.mozweb.co.mz/feeds/domainprice.php?tld=.com&type=register&regperiod=1&format=1&<?php echo $lang['website_currency']; ?>"></script>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <form method="post" action="https://cliente.mozweb.co.mz/cart.php?a=add&domain=register<?php echo $lang['whmcs_lang_parameter']; ?>" class="row m0 domain_search">
                ...
                <div class="col-sm-9 col-md-9 col-lg-10">
                    ...
                    <ul class="nav nav-pills price_list">
                        <li><img src="<?php echo $lang['website_global_img_link']; ?>assets/images/com.png"> &nbsp;<script language="javascript" src="https://cliente.mozweb.co.mz/feeds/domainprice.php?tld=.com&type=register&regperiod=1&format=1&<?php echo $lang['website_currency']; ?>"></script>
                        </li>
                        <li><img src="<?php echo $lang['website_global_img_link']; ?>assets/images/net.png"> &nbsp;<script language="javascript" src="https://cliente.mozweb.co.mz/feeds/domainprice.php?tld=.net&type=register&regperiod=1&format=1&<?php echo $lang['website_currency']; ?>"></script>
                        </li>
                        <li><img src="<?php echo $lang['website_global_img_link']; ?>assets/images/org.png"> &nbsp;<script language="javascript" src="https://cliente.mozweb.co.mz/feeds/domainprice.php?tld=.org&type=register&regperiod=1&format=1&<?php echo $lang['website_currency']; ?>"></script>
                        </li>
                        <li><img src="<?php echo $lang['website_global_img_link']; ?>assets/images/info.png"> &nbsp;<script language="javascript" src="https://cliente.mozweb.co.mz/feeds/domainprice.php?tld=.info&type=register&regperiod=1&format=1&<?php echo $lang['website_currency']; ?>"></script>
                        </li>
                    </ul>
                </div>
            </form>
                ...
                <div class="col-sm-3 service-tab-menu-1">
                    <div class="row service_tab_menu">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a href="#serviceT3" aria-controls="serviceT3" role="tab" data-toggle="tab" class="nav-link"><img src="" class="icon"><?php echo $lang['home_index_content_7']; ?></a>
                            </li>
                            <li role="presentation"><a href="#serviceT4" aria-controls="serviceT4" role="tab" data-toggle="tab" class="nav-link"><img src="" class="icon"><?php echo $lang['home_index_content_8']; ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-9 service-tab-menu-2">
                    <div class="row m0 serviceTab_contents">
                        <div class="tab-content">
                            <div class="tab-pane active" role="tabpanel" id="serviceT1">
                                <div class="col-md-6 ico_pic">
                                    <img src="<?php echo $lang['website_global_img_link']; ?>assets/images/mascote/mascote-home-mozweb.svg" alt="<?php echo $lang['home_index_content_alt_1']; ?>" class="service_img img-fluid fright">
                                </div>
                                <div class="col-md-6 texts">
                                    <?php echo $lang['home_index_content_9']; ?> <a href="<?php echo $lang['header_menu_link_5']; ?>" class="btn btn-primary"><?php echo $lang['home_index_content_10']; ?></a>
                                </div>
                            </div>
                            <div class="tab-pane" role="tabpanel" id="serviceT2">
                                ...
                                <div class="col-md-6 texts">
                                    <?php echo $lang['home_index_content_11']; ?> <a href="<?php echo $lang['header_menu_link_3']; ?>" class="btn btn-primary"><?php echo $lang['home_index_content_10']; ?></a>
                                </div>
                            </div>
                            <div class="tab-pane" role="tabpanel" id="serviceT3">
                                ...
                                <div class="col-md-6 texts">
                                    <?php echo $lang['home_index_content_12']; ?> <a href="<?php echo $lang['header_menu_link_49']; ?>" class="btn btn-primary"><?php echo $lang['home_index_content_10']; ?></a>
                                </div>
                            </div>
                            <div class="tab-pane" role="tabpanel" id="serviceT4">
                                ...
                                <div class="col-md-6 texts">
                                    <?php echo $lang['home_index_content_13']; ?> <a href="<?php echo $lang['header_menu_link_4']; ?>;" class="btn btn-primary"><?php echo $lang['home_index_content_10']; ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row m0 featureTab_contents">
            <div class="tab-content">
                <center><br><br><br><br><br>
                    <h1><?php echo $lang['home_index_content_26']; ?> <img src="<?php echo $lang['website_global_img_link']; ?>assets/images/emoji_campeoesvendas.png"></h1>
                </center>
